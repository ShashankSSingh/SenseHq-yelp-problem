...
restaurants_X = np.load('./data/' + file_city_name + '_restaurants_X.np', allow_pickle = True )
...
with open('./data/' + file_city_name + '_user_preference.np', 'wb') as file:
...
with open('./data/' + file_city_name + '_user_preference_cos.np', 'wb') as file:
