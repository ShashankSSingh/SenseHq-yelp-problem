...
with open('data/' + file_city_name + '_users_concat_reviews.txt', 'w', encoding = 'utf-8') as data_file:
	json.dump(user_concat, data_file)

with open('data/' + file_city_name + '_restaurants_concat_reviews.txt', 'w', encoding = 'utf-8') as data_file:
