...
cosine_similarities = np.load('./data/' + file_city_name + sorting_method, allow_pickle = True)
...
#print('testing mape:', utils.mape(overall_predictions, load_matrix.test_data_matrix))
#print('training mape:', utils.mape(overall_predictions, load_matrix.train_data_matrix))
...
with open('./data/' + file_city_name + sorting_method + '_all_predictions.np', 'wb') as file:
