...
with open('data/' + file_city_name + '_filtered_user_index.json', 'w', encoding = 'utf-8') as user_idx_file:
    json.dump(user_index_map, user_idx_file)
with open('data/' + file_city_name + '_filtered_restaurants_index.json', 'w', encoding = 'utf-8') as rest_idx_file:
