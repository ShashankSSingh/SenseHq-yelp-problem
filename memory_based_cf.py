...
import load_matrix
import utils
from load_matrix import file_city_name
...
#print('User-based CF mape: ' + str(utils.mape(user_prediction, test_data_matrix)))
#print('Item-based CF mape: ' + str(utils.mape(item_prediction, test_data_matrix)))
...
#print('User-based CF mape: ' + str(utils.mape(user_prediction, train_data_matrix)))
#print('Item-based CF mape: ' + str(utils.mape(item_prediction, train_data_matrix)))


with open('./data/' + file_city_name + 'memory_based_cf_user' + '_all_predictions.np', 'wb') as file:
	np.save(file, user_prediction)

with open('./data/' + file_city_name + 'memory_based_cf_item' + '_all_predictions.np', 'wb') as file:
